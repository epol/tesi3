...
\begin{figure}[h]
  ...
  \caption{Un albero con riportata sotto la posizione dei nodi nella
    stringa TODO scirvere meglio}
  \label{fig:labeltree}
\end{figure}
...
possibili, avendo fissato a $N$ il numero di vertici del grafo, \`e
