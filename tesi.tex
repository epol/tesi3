...
pessimo, $O\pa{ N^3 \log\pa{N}}$ bit, potremmo pensare di diminuire lo
spazio occupato calcolando i vicini buoni al momento della richiesta.

Nella preelaborazione, quindi, rimane solo il calcolo della matrice
delle distanze e il suo salvataggio (che sappiamo fare in $O\pa{ N^2}$
bit), ma nella richiesta dobbiamo aggiungere la ricerca dei vicini
``buoni''.
