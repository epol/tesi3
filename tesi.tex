...
= 2 \]
inoltre se $a_i \cap a_j \neq \emptyset$ i cammini minimi in $P\pa{
  a_i, a_j}$ sono tutti e soli quelli nella forma $a_i, b_k, a_j$ al
variare di $b_k \in a_i \cap a_j$.
...
Abbiamo quindi visto un possibile modo per costruire un lower bound
per lo spazio utilizzato da un oracolo per cammini minimi, resta
